...
3. Download project from github(https://github.com/Rithwikvarm/placement-cell).

OR follow gitbash commands

i> cd C:\\xampp\htdocs\

ii> git clone https://github.com/Rithwikvarm/placement-cell
...
7. Give a database name as (placement_cell) hit on create button.

8. After creating database name click on import.

9. Browse the file in directory [placement-cell/database/db1.sql].

10. Open any browser and type http://localhost/placement-cell.
